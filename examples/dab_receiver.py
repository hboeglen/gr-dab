...
class dab_receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "dab_receiver")
        ...
        self.var = var = dp.dab_parameters(1,samp_rate,0)
        ...
        self.dab_dabplus_audio_decoder_ff_1 = dab.dabplus_audio_decoder_ff(dab.parameters.dab_parameters(mode=1, sample_rate=samp_rate, verbose=False), 88, 528, 66, 2, True)
        self.blocks_vector_to_stream_0 = blocks.vector_to_stream(gr.sizeof_gr_complex*1, 1536)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(2048/30)
        ...
        self.connect((self.dab_dabplus_audio_decoder_ff_1, 1), (self.audio_sink_0, 1))
        self.connect((self.dab_dabplus_audio_decoder_ff_1, 0), (self.audio_sink_0, 0))
        self.connect((self.dab_ofdm_demod_cc_0, 0), (self.blocks_vector_to_stream_0, 0))
        self.connect((self.dab_ofdm_demod_cc_0, 1), (self.dab_dabplus_audio_decoder_ff_1, 0))
        self.connect((self.rtlsdr_source_0, 0), (self.dab_ofdm_demod_cc_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_var(dp.dab_parameters(1,self.samp_rate,0))
...
def main(top_block_cls=dab_receiver, options=None):
